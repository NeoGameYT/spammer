...
8888888888888888888888888
888██8888██88████████8888      
888██8888██88888██8888888
8888██88██888888██8888888
888888██88888888██8888888
888888██88888888██8888888
888888██88888888██8888888
888888██88888888██8888888
888888██88888888██8888888
...
8888888888888888888888888'''+Style.RESET_ALL)
		...
		parser = argparse.ArgumentParser(prog='spammer', description="Fucking shit by NeoGameYT. Возможно что-то уже не работает. Только для России!",epilog='Мой e-mail - Gmashinka@mail.ru')
		parser.add_argument('phonenum', metavar='phone', help='Телефонный номер жертвы (пример: 79991234455)')
		args = parser.parse_args()
		_phone = args.phonenum

		if _phone == "update":
			cmd = os.system("cd && rm -rf ~/spammer && git clone https://github.com/NeoGameYT/spammer && sh ~/spammer/install.sh")
			exit()
